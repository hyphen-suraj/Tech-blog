...
if(!$add_post){
  ...
  echo "<p class='bg-success'>Post Added <a href='../prt_blog.php?blog_id= $add_post_id '>view Post</a></p>";
...
<textarea type="text" class="form-control" name="post_content" id="editor1" cols="30" rows="10"></textarea>
</div>
